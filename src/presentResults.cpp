...
void startPresentation( CStorage & images ) {
    ...
    while ( true ){
        ...
        while( true ){
            ...
            //CTRL+D check
            if ( cin.eof() ){
                cout << "\033[1;31mThe input was ended forcibly\033[0m" << endl;
                return;
            }
            ...
            if ( answer == "n" || answer == "N" ){
               ...
               break;
                ...
                cout << "\033[1;32mThank you for using my ASCII-converter\033[0m" << endl;
                return;
            } else {
...
void presentResults( CStorage &images ){
    cout << "\033[1;33mDo you want to see the results of the conversion? [y/n]\033[0m" << endl;
    ...
    while( true ){
        ...
        if ( answer == "y" || answer == "Y" || answer == "YES" || answer == "yes" ){
            ...
            cout << "\033[1;32mOK! Results are already saved in files :)\033[0m" << endl;
            cout << "\033[1;32mThanks for using my ASCII-converter\033[0m" << endl;
            return;
        } else {
